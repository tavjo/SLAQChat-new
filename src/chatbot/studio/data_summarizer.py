...
def data_summarizer_node(state: ConversationState) -> Command[Literal["responder"]]:
    payload = {
    ...
    result = baml.SummarizeData(payload)
...
if __name__ == "__main__":
    initial_state: ConversationState = {
        "messages": [
            ...
            HumanMessage(content="The conversation has progressed to the point where the necessary information about the sample has likely been retrieved. The next step is to summarize this information for the user to ensure clarity and readability.", name="responder")
            ],
    ...
    data_summarizer_node(initial_state)